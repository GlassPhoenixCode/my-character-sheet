    ...
    return (
        <>
            <div className={styles.encounterForm}>
                        ...
                        { encounter.monsters.map((creature, index) => (
                            <div key={creature.id} className={styles.creature}>
                                <span className={styles.name}>
                                    { mode === 'player' && creature.portrait ? (
                                        <img className={styles.portrait} src={creature.portrait} alt="" />
                                    ) : null }
                ...
                { (mode === "monster" && encounter.monsters.length) ? (
                    <button className={styles.clearCreaturesBtn} onClick={clearCreatures}>
                        <FontAwesomeIcon icon={faTrash} />
                        Clear Enemies
                    </button>
                ) : null }
